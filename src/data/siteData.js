...
export const defaultMenuSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 12, ar: "فقع موكرم", he: "פטריות מוקרמות", price: 60, image: "/images/M1.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 24, ar: "ستيك انتريكوت", he: "סטייק אנטריקוט", price: 120, image: "/images/steak1.jpg" },
      ...
      desc: "موزات خروف مطهية بعناية بطعم شرقي فاخر"
    }
    ]
  },
  {
    ...
    titleHe: "שתייה",
    items: [
      { id: 29, ar: "مياه معدنية", he: "מים מינרלים", price: 10, image: "/images/water.jpg" },
      { id: 30, ar: "كوكا كولا", he: "קוקה קולה", price: 12, image: "/images/cola.jpg" },
      { id: 31, ar: "سبرايت", he: "ספרייט", price: 12, image: "/images/drinks.jpg" },
      { id: 32, ar: "فانتا", he: "פאנטה", price: 12, image: "/images/fanta.jpg" },
  ...
  id: "fish",
  titleAr: "أسماك وفواكه بحر",
  titleHe: "דגים ופירות ים",
  items: [
   
    {
      ...
      desc: "سمك دنيس طازج مشوي أو مقلي حسب الاختيار"
    },
    {
      id: 41,
      ar: "لبرك",
      he: "לברק",
      price: 110,
      image: "/images/labrak.jpg",
      desc: "سمك لبرك طازج بتتبيلة كازابلانكا الخاصة"
    },
    {
      id: 42,
      ar: "كلماري",
      ...
      desc: "كلماري طازج مقلي أو مطبوخ بتقديم فاخر"
    },
    {
      id: 43,
      ar: "شرمس /كلماري",
    ...
    },
    {
      ...
      he: "שרימפס מטוגן",
      price: 120,
      image: "/images/fried-shrimp.jpg",
      desc: "جمبري مقلي مقرمش بتقديم راقٍ"
    },
    {
      id: 45,
      ar: "فواكه بحر",
      ...
      desc: "تشكيلة فواكه بحر طازجة لمحبي النكهات البحرية"
    }
  ]
}
...
export const translations = {
  ar: {
    ...
    menu: "المنيو",
    cart: "السلة",
    heroTitle: "كازابلانكا — فخامة المذاق الشرقي",
    heroText:
      "تجربة طعام راقية تجمع بين المشاوي، المقبلات، الأطباق البحرية، والحلويات الشرقية بأجواء فاخرة.",
    orderNow: "اطلب الآن",
    exploreMenu: "شاهد المنيو",
    signature: "أطباق مميزة",
    storyTitle: "أصالة شرقية بلمسة عصرية",
    storyText:
      "في كازابلانكا نقدم تجربة طعام دافئة وفاخرة، حيث يجتمع الطعم الأصيل مع التقديم الراقي والخدمة المميزة.",
    footerText: "مطعم كازابلانكا — طعم شرقي فاخر وتجربة لا تُنسى.",
  },
  he: {
    home: "בית",
    menu: "תפריט",
    cart: "עגלה",
    heroTitle: "קזבלנקה — טעם מזרחי יוקרתי",
    heroText:
      "חוויה קולינרית אלגנטית עם גריל, סלטים, מנות ים וקינוחים באווירה יוקרתית.",
    orderNow: "הזמן עכשיו",
    exploreMenu: "צפה בתפריט",
    signature: "מנות נבחרות",
    storyTitle: "אותנטיות מזרחית בנגיעה מודרנית",
    storyText:
      "בקזבלנקה אנו מגישים חוויה חמה ויוקרתית, עם טעמים אותנטיים, הגשה מוקפדת ושירות איכותי.",
    footerText: "מסעדת קזבלנקה — טעם מזרחי יוקרתי וחוויה בלתי נשכחת.",
  },
  en: {
    home: "Home",
    menu: "Menu",
    cart: "Cart",
    heroTitle: "Casablanca — Luxury Oriental Taste",
    heroText:
      "A premium dining experience with grills, starters, seafood, desserts and warm luxury atmosphere.",
    orderNow: "Order Now",
    exploreMenu: "Explore Menu",
    signature: "Signature Dishes",
    storyTitle: "Oriental Authenticity With a Modern Touch",
    storyText:
      "At Casablanca, we serve a refined dining experience where authentic flavors meet elegant presentation and warm hospitality.",
    footerText: "Casablanca Restaurant — premium oriental taste and unforgettable experience.",
  },
};
